...
$wpdb->insert('booking_flight_instructors',array('instructor_name' => $_POST['name'],'flight_id'=> $_POST['flight_id']),array('%s','%d'));
}
if($_POST['update_instructor'] == "Update Instructor"){
$wpdb->update( 'booking_flight_instructors', array('instructor_name' => $_POST['name'],'flight_id'=> $_POST['flight_id']), array('id' => $_GET['edit']) ); 
}
if($_GET['delete']){
$wpdb->delete('booking_flight_instructors',array('id'=> $_GET['delete'])); 
}
?>
...
<?php
if($_GET['edit']){
$edited = $wpdb -> get_results("select * from booking_flight_instructors where id =".$_GET['edit']);
?>
<h3 class="booking_h3">Edit Instructor</h3>
<a href="?page=booking-manage-instructors">Add new</a>
...
?>
<tr>
	<td><?php echo $row1->instructor_name;?></td><td><a class="booking_button" href="?page=booking-manage-instructors&edit=<?php echo $row1->id;?>">Edit</a>&nbsp;&nbsp;<a class="booking_button" href="?page=booking-manage-instructors&delete=<?php echo $row1->id;?>" onclick="javascript:return confirm('Are you sure to delete it?')">Delete</a></td>
</tr>
<?php } ?>
</table>
